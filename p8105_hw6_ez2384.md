...
![](p8105_hw6_ez2384_files/figure-gfm/Distribution%20Plots-1.png)<!-- -->
...
![](p8105_hw6_ez2384_files/figure-gfm/Plot-1.png)<!-- -->
...
```
    ...
    ## # A tibble: 6 × 9
    ##   train                   test                  .id   backward model1 model2
    ...
    ## # ℹ 3 more variables: backward_rmse <dbl>, model1_rmse <dbl>, model2_rmse <dbl>
...
![](p8105_hw6_ez2384_files/figure-gfm/prob3%20plot-1.png)<!-- -->
